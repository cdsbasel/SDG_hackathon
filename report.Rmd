...
ggplot(sdg_props, aes(x = sdg_nam, y = prop)) + 
  ...
  labs(x = "", y = "Relative frequency",
       caption = "Note: Red line shows relative frequency of SDG-matches reported by Elsevier (2020) based on a full literature search") +
...
Notably, the organizational units contribute to SDG-03 in different ways. Publications of Swiss Tropical and Public Health Institute were most often identified as contributing to SDG-03 for including the keyword "malaria", those of the Faculties of Science and Medicine and the Institute for Biomedical Ethics for including the keyword "cancer", and those of the Faculty of Psychology for including the keyword "mental disorder". 
