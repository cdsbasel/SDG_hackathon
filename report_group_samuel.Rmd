...
Only Publications and Projects that were published or completed from 2010 to 2020 were included.The Query search  

Query search using Aurora (Link). 
...
The figure below shows the number of projects dealing with the SDGs. Externally funded projects are in a lighter hue and internally funded projects are in the darker hue. Again out of the `r toString(n_projects)` projects concerning SDGs SDG-03 receives the most attention with a total of 234 projects.
