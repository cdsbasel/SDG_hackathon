...
Only publications and projects that were published or completed from 2010 to 2020 were included in the analyses, leading to `r toString(n_publications)` publications, as well as `r toString(n_projects)` projects. In total  `r toString(n_matches_publications)` matches for publications and `r toString(n_matches_projects)` for projects were found. 
